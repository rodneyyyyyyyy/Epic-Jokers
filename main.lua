...
local jokerIndexList = {1,5,6,2,4,3}
...
SMODS.ObjectType({
    key = "epicjokers_mycustom_jokers",
    cards = {
        ["j_epicjokers_cano"] = true,
        ["j_epicjokers_trib"] = true
    },
})

SMODS.ObjectType({
    key = "epicjokers_epicjokers_jokers",
    cards = {
        ["j_epicjokers_chic"] = true,
        ["j_epicjokers_gumbly"] = true,
        ["j_epicjokers_perk"] = true,
        ["j_epicjokers_york"] = true
    },
})
